...
public class FileController {
	...
	String reg1(
			...
			@RequestParam("ff2") MultipartFile ff2, HttpServletRequest request)
	{
		...
		for(MultipartFile mf : ff1) {
			...
			System.out.println(mf.isEmpty());// 파일이 있냐 없냐
		}
...
//		
	...
	void fileSave(MultipartFile mf,HttpServletRequest request) {
		...
		path = "C:\\Users\\ekqls\\OneDrive\\Desktop\\study\\java_work\\springmvcprj\\src\\main\\webapp\\fff";
