...
//			 외부 클래스의 멤버접근 : 외부클래스.this.멤버요소
		 ...
		 static void meth_s2() {
				System.out.println("InnMM.스태틱 meth_2()");
				}
		 static	void meth_s3() {
				 System.out.println("InnMM.스태틱 meth_3()");
			 }
...
//	 스태틱멤버변수로 일반 이너클래스 사용불가 - 스태틱이너 클래스만 가능
...
public class NestedMain {
	...
	public static void main(String[] args) {
		 ...
		 NNOuter oo2 = new  NNOuter("장남건", 47);
...
//		 System.out.println("oo1.mm1 : " +oo1.mm1.age);  외부 인스턴스 멤버 접근 불가
		 System.out.println("oo1 스태틱 : " +oo1.sa+","+oo1.sb);
		 System.out.println("oo1.mm1 스태틱 : " +oo1.mm1.sa+","+oo1.mm1.sb);
		 
//		 System.out.println("oo1.InnMM. 스태틱 : " +oo1.InnMM.mm1.sa+","+oo1.InnMM.sb);
...
//		 NNOuter.InnMM ni1 = new NNOuter.InnMM("강백호",19);
		 ...
		 NNOuter.InnMM ni21 = oo2.new InnMM("윤대협",22);
		 NNOuter.InnMM ni22 = oo2.new InnMM("변덕규",21);
